/**
 * Main Application Controller for VJ Portfolio
 * Handles navigation, routing, and project display
 */
class VJApp {
  constructor() {
    this.loader = new VJProjectLoader();
  ...
  renderGallery() {
    ...
    title.textContent = categoryNames[this.currentCategory] || 'VJ Synth Lab';
  ...
  async showProject(project) {
    ...
    // Load project
    this.currentViewer = new VJProjectViewer(container, project);
