/**
 * Project Viewer for VJ Portfolio
 * Handles loading and displaying VJ mixer projects
 */
class VJProjectViewer {
  ...
  async load() {
    ...
    this.iframe.style.background = '#0d1228';
...
if (typeof window !== 'undefined') {
  window.VJProjectViewer = VJProjectViewer;
}
