...
const Animator: React.FC = () => {
    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                name="Path Animator"
                whenToUse="After finalizing your design, use this to add motion. Works best after optimizing your SVG."
                howItWorks="Create animations for your SVG paths. Choose from multiple animation types including drawing effects, fades, and more."
                description="Add CSS or GSAP animations to SVG paths for interactive designs."
            />
