...
const Generators: React.FC = () => {
    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                name="Generators"
                whenToUse="When you need repetitive patterns or procedural shapes."
                howItWorks="Generate patterns, grids, and custom shapes programmatically."
                description="Create radial repeats, QR codes, charts, and other generated patterns."
            />
