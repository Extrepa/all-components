    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                ...
                whenToUse="At the beginning of your workflow. Use templates to learn SVG structure or as starting points for new designs."
                howItWorks="Quick-start with pre-built SVG templates or save your current SVG as a template. Templates help you understand SVG structure and jump into editing quickly."
                description="Save and load SVG templates for quick project starts."
            />

            <div className="tool-parameters">
                <label className="form-label">Saved Templates ({state.templates.length})</label>
                {state.templates.length > 0 ? (
                    <div className="template-list" style={{ marginBottom: '1rem', maxHeight: '300px', overflowY: 'auto', border: '1px solid var(--border-color)', borderRadius: 'var(--border-radius)', padding: '0.5rem' }}>
                    ...
                    <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)', marginBottom: '1rem', padding: '0.75rem', background: 'var(--bg-secondary)', borderRadius: 'var(--border-radius)' }}>
                        No saved templates yet. Save your current SVG as a template below.
                    </p>
                )}

                <label className="form-label" style={{ marginTop: '1rem' }}>Save Current SVG as Template</label>
