    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                ...
                whenToUse="After selecting paths or groups, use this to modify their properties and attributes."
                howItWorks="Edit all attributes (ID, fill, stroke, opacity, and more) for selected paths or groups. All selected items will be updated together."
                description="Modify visual and structural attributes of selected paths and groups."
            />
