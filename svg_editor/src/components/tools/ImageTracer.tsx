...
const ImageTracer: React.FC = () => {
    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                name="Image Tracer"
                whenToUse="Start your workflow by converting raster images to SVG. Works best with simple images, logos, and line art."
                howItWorks="Upload a PNG or JPG image and convert it to SVG paths. Uses edge detection to trace the image and create vector paths."
                warnings="Complex photos may produce large SVG files. Best for simple graphics."
            />
            ...
            <div className="tool-parameters">
                ...
                <label className="form-label" style={{ marginTop: '1rem' }}>Tracing Options</label>
