    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                ...
                whenToUse="When you need to know exact distances between points or precise coordinates for bridging."
                howItWorks="Measure distances, inspect coordinates, and get precise dimensions. Essential for closing gaps and precision work."
                description="Measure distances and inspect path dimensions for precision work."
            />
            ...
            {measurements.length > 0 && (
                <div className="tool-parameters" style={{ marginTop: '1rem' }}>
