...
const PathSimplifier: React.FC = () => {
    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                name="Path Simplifier"
                whenToUse="After creating or importing paths, use this to clean them up. Works great with traced images or complex paths."
                howItWorks="Reduce path complexity by removing unnecessary points and simplifying curves. This reduces file size and improves performance."
                warnings="Higher simplification may change path appearance. Preview changes before applying."
            />

            {selectedCount === 0 ? (
                <div className="tool-status-section">
                    <p style={{ color: 'var(--text-secondary)', marginBottom: '0.75rem', textAlign: 'center' }}>No paths selected (will simplify all paths)</p>
                </div>
            ) : (
                <div className="tool-status-section ready">
            ...
            <div className="tool-parameters">
                ...
                <label className="form-label" style={{ marginTop: '1rem' }}>Options</label>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer' }}>
                    ...
                    />
                    <span>Remove redundant commands</span>
                </label>
            </div>
