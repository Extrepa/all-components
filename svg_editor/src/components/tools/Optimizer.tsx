...
const Optimizer: React.FC = () => {
    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                name="SVG Optimizer"
                whenToUse="Before exporting for production. Use this near the end of your workflow, after all editing is complete."
                howItWorks="Clean and optimize your SVG to reduce file size while maintaining visual quality. Removes unnecessary data, rounds coordinates, and reduces path complexity."
                description="Optimize SVG files for production by removing unnecessary data and reducing file size."
            />
