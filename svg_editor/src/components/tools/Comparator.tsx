...
const Comparator: React.FC = () => {
    ...
    return (
        <div className="tool-panel-content">
            <ToolHeader
                name="SVG Comparator"
                whenToUse="When you need to see what changed between two versions of an SVG."
                howItWorks="Compare two SVG files side-by-side to identify differences in paths, attributes, and structure."
                description="Load and compare two SVG files to identify differences."
            />
