...
const PreviewArea: React.FC = () => {
    ...
    usePanAndZoom(); // Enable pan and zoom functionality
    usePathDrag(); // Enable drag-to-move functionality
    useMarqueeSelection(); // Enable marquee selection
    useContextMenu(); // Enable context menu
    useCanvasTools(); // Coordinate canvas tool behaviors
