...
This directory contains detailed documentation for the errl-fluid project.
...
- [ERRL Specification](../ERRL-SPEC.md) - Master specification and testing protocol for the Errl fluid simulation system
