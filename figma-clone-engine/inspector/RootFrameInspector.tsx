...
interface RootFrameInspectorProps {
  state: DesignState;
  panelWidth: number;
...
export const RootFrameInspector: React.FC<RootFrameInspectorProps> = ({
  state,
  panelWidth,
  panelRef,
  handleResize,
            ...
            <>
              ...
              <div className="border-b border-gray-700/50">
                <div 
                  ...
                  className="w-full flex items-center justify-between px-2 py-1.5 hover:bg-gray-700/30 text-left cursor-pointer"
                >
                  <div className="flex items-center gap-2">
